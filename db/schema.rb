...
ActiveRecord::Schema.define(version: 2019_12_03_174617) do
  ...
  create_table "meta_attribute_entities", id: :serial, force: :cascade do |t|
    ...
    t.index ["entity_group"], name: "index_meta_attribute_entities_on_entity_group"
  end
  ...
  create_table "meta_attribute_questions", id: :serial, force: :cascade do |t|
    ...
    t.boolean "visible", default: true
    t.text "short_name"
    t.index ["attribute_name"], name: "index_meta_attribute_questions_on_attribute_name"
    t.index ["category"], name: "index_meta_attribute_questions_on_category"
  end
  ...
  create_table "survey_labels", force: :cascade do |t|
    t.integer "lime_survey_sid"
    t.string "year"
    t.string "program"
    t.string "label"
    t.datetime "created_at", default: "2019-11-27 20:20:49", null: false
    t.datetime "updated_at", default: "2019-11-27 20:20:49", null: false
    t.integer "label_position"
    t.integer "program_position"
    t.index ["lime_survey_sid"], name: "index_survey_labels_on_lime_survey_sid"
  end
  ...
  create_table "user_externals", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_user_externals_on_user_id"
  end
